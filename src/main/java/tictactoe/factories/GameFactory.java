...
public class GameFactory {
    ...
    public static TicTacToe createHumanVsHuman(String player1Name, String player2Name, String icon1, String icon2) {
    ...
    public static TicTacToe createHumanVsComputer(String playerName, String humanIcon, String computerIcon, MoveStrategy strategy) {
    ...
    public static TicTacToe createComputerVsComputer(String icon1, String icon2) {
